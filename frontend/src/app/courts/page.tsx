        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courts.map((court, idx) => (
            <motion.div
              ...
              className="bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden hover:border-teal-500/50 transition-colors group flex flex-col shadow-xl"
            >
              <div className="h-60 relative overflow-hidden">
                <img 
                  src={court.imageUrl || "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=800&q=80"} 
                  alt={court.name}
